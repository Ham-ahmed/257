...
echo -e "${CYAN}"
echo "################################################################"
echo "#       Start downloading and installing xstreamity_5.58       #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/257/refs/heads/main/enigma2-plugin-extensions-xstreamity_5.58.20260720_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xstreamity_5.58.20260720_all.ipk"
...
echo "#${BLUE}            ON - MagicPanelGold v11.0          ${PURPLE}#"
